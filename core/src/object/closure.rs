...
impl Closure {
  ...
  /// # Example
  /// ```
  /// use tube_core::object::{Closure, Class, FunBuilder};
  /// use tube_core::signature::Arity;
  /// use tube_core::module::Module;
  /// use tube_core::captures::Captures;
  /// use tube_core::hooks::{NoContext, GcHooks};
  /// use tube_core::chunk::Chunk;
