...
impl<'a> Hooks<'a> {
  ...
  /// # Examples
  /// ```
  /// use tube_core::hooks::{Hooks, NoContext};
  /// use tube_core::value::Value;
  ///
...
impl<'a> GcHooks<'a> {
  ...
  /// # Examples
  /// ```
  /// use tube_core::hooks::{GcHooks, NoContext};
  /// use tube_core::value::Value;
  /// use tube_core::memory::Allocator;
  ///
  /// let mut context = NoContext::default();
...
impl<'a> ValueHooks<'a> {
  ...
  /// # Examples
  /// ```
  /// use tube_core::hooks::{ValueHooks, NoContext};
  ///
  /// let mut context = NoContext::default();
