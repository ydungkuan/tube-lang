...
mod test {
  ...
  use tube_core::object::Enumerator;
  ...
  mod map {
    ...
    use tube_core::{captures::Captures, object::Closure, chunk::Chunk};
  ...
  mod all {
    use super::*;
    use crate::support::MockedContext;
    use tube_core::{object::Enumerator, value::VALUE_TRUE};
  ...
  mod into {
    use super::*;
    use crate::support::MockedContext;
    use tube_core::object::{Enumerator, LyNative};
