...
fn criterion_benchmark(c: &mut Criterion) {
  let binary_trees_path = fixture_path("binary_trees.tube").expect("Unable to load benchmark file.");
  let channel_path = fixture_path("channel.tube").expect("Unable to load benchmark file.");
  let equality_path = fixture_path("equality.tube").expect("Unable to load benchmark file.");
  let fibers_path = fixture_path("fibers.tube").expect("Unable to load benchmark file.");
  let fib_path = fixture_path("fib.tube").expect("Unable to load benchmark file.");
  let instantiation_path =
    fixture_path("instantiation.tube").expect("Unable to load benchmark file.");
  let invocation_path = fixture_path("invocation.tube").expect("Unable to load benchmark file.");
  let method_call_path = fixture_path("method_call.tube").expect("Unable to load benchmark file.");
  let properties_path = fixture_path("properties.tube").expect("Unable to load benchmark file.");
  let trees_path = fixture_path("trees.tube").expect("Unable to load benchmark file.");
  let zoo_path = fixture_path("zoo.tube").expect("Unable to load benchmark file.");
  let string_path = fixture_path("string.tube").expect("Unable to load benchmark file.");
  let fluent_path = fixture_path("fluent.tube").expect("Unable to load benchmark file.");
