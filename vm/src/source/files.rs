...
impl LineOffsets {
  ...
  /// # Examples
  /// ```
  /// use tube_vm::source::LineOffsets;
  ///
  ...
  /// # Examples
  /// ```
  /// use tube_vm::source::{LineOffsets, LineError};
  ///
  /// let offsets = LineOffsets::new(vec![0, 10], 20);
...
impl VmFiles {
  ...
  /// # Examples
  /// ```
  /// use tube_core::memory::{Allocator, NO_GC};
  /// use tube_vm::source::VmFiles;
  ///
  /// let mut alloc = Allocator::default();
  /// let name1 = alloc.manage_str("first.tube", &NO_GC);
  /// let name2 = alloc.manage_str("second.tube", &NO_GC);
  ///
  ...
  /// ```
  /// use tube_core::memory::{Allocator, NO_GC};
  /// use tube_vm::source::{VmFiles, LineOffsets};
  ///
  /// let mut alloc = Allocator::default();
  ///
  /// let name = alloc.manage_str("first.tube", &NO_GC);
